...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/permissions/common-kbs": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "operator_usid, kb_id, note",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.CommonKBRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/permissions/kb-acl": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "list this KB's members (mode A)",
                        "name": "kb_id",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "list KBs accessible to this usid (mode B)",
                        "name": "usid",
                        "in": "query"
                    }
                ],
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "operator_usid, kb_id, usid, role(admin|normal)",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.KBAclUpsertRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "operator_usid, kb_id, usid",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.KBAclRemoveRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/permissions/kb-acl/batch": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "operator_usid, kb_id, admins[], normals[]",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.KBAclBatchRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/permissions/searchable-kbs": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "the usid whose searchable KBs to list",
                        "name": "usid",
                        "in": "query",
                        "required": true
                    },
                    {
                        "type": "string",
                        "description": "operator's usid; required (and must be a super_user) only when different from usid",
                        "name": "operator_usid",
                        "in": "query"
                    }
                ],
        ...
        "/permissions/super-users": {
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "operator_usid, usid, note",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_handler.SuperUserRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_Tencent_WeKnora_internal_types.KBAclDisplaySource": {
            "type": "object",
            "properties": {
                "admins": {
                    "type": "array",
        ...
        "internal_handler.CommonKBRequest": {
            "type": "object",
            "properties": {
                "kb_id": {
                    "type": "string"
        ...
        "internal_handler.KBAclBatchRequest": {
            "type": "object",
            "properties": {
                "admins": {
                    "type": "array",
        ...
        "internal_handler.KBAclRemoveRequest": {
            "type": "object",
            "properties": {
                "kb_id": {
                    "type": "string"
        ...
        "internal_handler.KBAclUpsertRequest": {
            "type": "object",
            "properties": {
                "kb_id": {
                    "type": "string"
        ...
        "internal_handler.SuperUserRequest": {
            "type": "object",
            "properties": {
                "note": {
                    "type": "string"
